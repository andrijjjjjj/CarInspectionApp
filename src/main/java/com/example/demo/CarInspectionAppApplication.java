...
public class CarInspectionAppApplication {
	...
	public CommandLineRunner loadData(DriverRepository repo, MainController controller) {
		return (args) -> {
			Driver a = new Driver("Andrij", "P*******", "01/02/3456", "123-456-7890", "andrij@email.com", "ap123456", "andrijspassword", false);
			Driver b = new Driver("Braden", "M*******", "02/03/4567", "987-654-3210", "braden@email.com", "bm234567", "bradenspassword", false);
			Driver c = new Driver("Lasean", "J*******", "03/04/5678", "123-789-4560", "lasean@email.com", "lj345678", "laseanspassword", false);
