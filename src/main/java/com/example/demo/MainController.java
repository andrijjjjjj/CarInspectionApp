...
public class MainController {
	...
	public @ResponseBody String addNewDriver (@RequestParam String firstName, @RequestParam String lastName, 
			@RequestParam String birthday, @RequestParam String phoneNumber, 
		...
		Driver n = new Driver(firstName, lastName, birthday, phoneNumber, email, username, password, isSigned);
